		...
		[
			...
			_List_fromArray(
				[
					...
					_List_fromArray(
						[
							$elm$html$Html$Attributes$href('https://github.com/TheikChan')
						]),
					_List_fromArray(
						[
			...
			_List_fromArray(
				[
					...
					_List_fromArray(
						[
							$elm$html$Html$Attributes$href('https://www.linkedin.com/in/theik-chan-9a3b6210a/')
						]),
					_List_fromArray(
						[
...
var $author$project$Main$aboutSection = A2(
	...
	_List_fromArray(
		[
			$elm$html$Html$Attributes$class('section about')
		]),
	_List_fromArray(
		[
			A2(
...
var $author$project$Main$contactSection = A2(
	...
	_List_fromArray(
		[
			$elm$html$Html$Attributes$class('section contact')
		]),
	_List_fromArray(
		[
			A2(
...
var $author$project$Main$projectsSection = A2(
	...
	_List_fromArray(
		[
			$elm$html$Html$Attributes$class('section projects')
		]),
	_List_fromArray(
		[
			A2(
						...
						[
							...
							_List_fromArray(
								[
									...
									$elm$html$Html$Attributes$class('card-image'),
									$elm$html$Html$Attributes$alt('DreamHouse - Real Estate')
								]),
							_List_Nil),
							A2(
							$elm$html$Html$div,
								...
								[
									...
									_List_fromArray(
										[
											...
											_List_fromArray(
												[
													$elm$html$Html$text('DreamHouse - Real Estate'),
													$elm$html$Html$text(' '),
													A2(
													$elm$html$Html$a,
													_List_fromArray(
...
var $author$project$Main$skillSection = A2(
	...
	_List_fromArray(
		[
			$elm$html$Html$Attributes$class('section skill')
		]),
	_List_fromArray(
		[
			A2(
			...
			_List_fromArray(
				[
					...
					_List_fromArray(
						[
							$elm$html$Html$text('iOS: SwiftUI, UIKit, SnapKit, Combine, RxSwift, Concurrency')
						])),
					A2(
					$elm$html$Html$li,
					_List_Nil,
					...
					_List_fromArray(
						[
							$elm$html$Html$text('Cross-Platform: Flutter, React Native')
						])),
					A2(
					$elm$html$Html$li,
					_List_Nil,
...
var $author$project$Main$mainContent = A2(
	$elm$html$Html$div,
	_List_fromArray(
		[
...
var $author$project$Main$view = function (model) {
	return A2(
		...
		_List_fromArray(
			[$author$project$Main$header, $author$project$Main$mainContent, $author$project$Main$footer]));
};
