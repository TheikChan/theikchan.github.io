...
skillSection =
    div [ class "section skill" ]
        [ h2 [] [ text "Key Skill" ]
        , ul []
            [ li [] [ text "Programming Language: Swift, Objective-C, Kotlin, Java, C++, JavaScript, TypeScript" ]
            ...
            , li [] [ text "Backend: Java Spring Boot" ]
            , li [] [ text "Mobile Architecture: MVC, MVP, MVVM, VIPER, Clean Architecture, Modular Architecture" ]
            , li [] [ text "Database: Realm, Core Data, Swift Data, SQLite, Room, MySQL, PostgreSQL, NoSQL" ]
            , li [] [ text "Testing: XCTest, Swift Testing, JUnit, Mockito, UI Testing, Unit Testing, Integration Testing, Automation Testing, Appium" ]
            , li [] [ text "Security: Security Framework, Encryption, Secure Communication" ]
            , li [] [ text "DevOps: Jenkins CI/CD, Fastlane, GitLab, Github Actions, Docker" ]
            , li [] [ text "Tools: Xcode, Android Studio, VS Code, Copolit, Gemini, Git, Git-flow, npm, Cocoapods, SPM, Gradle, Maven, Firebase, TestFlight, Figma, Jira, Confluence" ]
